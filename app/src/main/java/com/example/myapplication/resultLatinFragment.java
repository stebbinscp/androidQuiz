...
public class resultLatinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View containerView =  inflater.inflate(R.layout.fragment_result_latin, container, false);
        ...
        anotherQuizButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(containerView).navigate(R.id.action_resultLatinFragment_to_latinFragment);
            }
        });
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(containerView).navigate(R.id.action_resultLatinFragment_to_welcomeFragment);
            }
        });
