...
public class resultGreekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        anotherQuizButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(containerView).navigate(R.id.action_resultGreekFragment_to_greekFragment);
            }
        });
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(containerView).navigate(R.id.action_resultGreekFragment_to_welcomeFragment);
            }
        });
