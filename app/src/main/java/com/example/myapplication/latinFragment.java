...
public class latinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View containerView = inflater.inflate(R.layout.fragment_latin, container, false);
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(view).navigate(R.id.action_latinFragment_to_resultLatinFragment);
            }
        });
    ...
    private void submit(View view) {
        ...
        if (guess.equals(question.getLatin())) {
